...
import TextPlaceholder from "../../../../components/ui/TextPlaceholder/TextPlaceholder";
    ...
    return (
        <SafeAreaView style={styles.list}>
            ...
            {!chatsStore.chats.length
                && <TextPlaceholder text="No active chats at the moment. Start a new chat or join existing ones to initiate conversations!" />
            }
            {!!chatsStore.chats.length &&
              <Animated.FlatList
                refreshControl={(
